...
## 5. Нуклеосинтез дейтерия: количественная проверка структуры протона

### 5.1 Слияние p + n → d + γ в информационных единицах
...
### 5.2 Спиновая структура дейтрона как проверка структуры протона
...
### 5.3 Космологический нуклеосинтез дейтерия (BBN)
...
6. **Открытые вопросы**: 3+1D-обобщение правила материи; происхождение
   совпадений π⁵ ≈ 17·18 и r_p = 4λ̄_p; осцилляции нейтрино; динамика сильного
   взаимодействия (прошивка кварков).
